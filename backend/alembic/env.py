...
# Añadir la carpeta backend al path
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

# Importar configuración y metadatos del ORM
from app.infrastructure.config.settings import settings
from app.infrastructure.database.session import Base

# IMPORTANTE: Importar todos los modelos para que alembic los detecte para autogenerate
...
# Sobrescribir la URL de conexión en el config con la de variables de entorno
